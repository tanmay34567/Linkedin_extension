...
2. From your project root run the following commands (replace <remote-url> with your repo URL):
...
- Visit your GitHub repo URL to confirm files are uploaded

Automation scripts are available in the `scripts/` folder to help with Windows or Unix shells.
